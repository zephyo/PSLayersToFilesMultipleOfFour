...
var strCheckboxMultiplesOfFour = "Multiples of Four";
...
function settingDialog(exportInfo) {
    ...
    // -- multiples of four
    dlgMain.cbMultiplesOfFour = dlgMain.grpTopLeft.add("checkbox", undefined, strCheckboxMultiplesOfFour);
    dlgMain.cbMultiplesOfFour.value = exportInfo.multiplesOfFour;
    ...
    exportInfo.multiplesOfFour = dlgMain.cbMultiplesOfFour.value;
...
function initExportInfo(exportInfo) {
    ...
    exportInfo.multiplesOfFour = false;
